...
urlpatterns = [
    ...
    path('filmwatch/delete', FilmWatchDeleteRedirectView.as_view(), name='filmwatch_deleteredirect'),
    ...
    path('film/delete', FilmDeleteRedirectView.as_view(), name='film_deleteredirect'),
    ...
    path('filmgroup/delete', FilmGroupDeleteRedirectView.as_view(), name='filmgroup_deleteredirect'),
